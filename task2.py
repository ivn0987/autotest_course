...
def flatten_and_sort(array):
    """
    Функция принимает двумерный массив array и возвращает плоский отсортированный список result_list
    :param array: list Двумерный массив
    :return: (result_list) list Список, отсортированный по убыванию
    """
    result_list = []
    for arr in array:
