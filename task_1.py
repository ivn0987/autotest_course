...
def letter_stat(our_str):
    """
    Функция принимает строку our_str и возвращает словарь letters_dict
    с ключом - буквой в строке our_str и значением - количеством вхождений буквы в строку
    :param our_str: str Строка
    :return: (letters_dict) dict Словарь {буква: количество вхождений буквы в строку}
    """
    letters_dict = {}
    our_set = set(our_str)
    for item in our_set:
        letters_dict[item] = our_str.count(item)
    return letters_dict
