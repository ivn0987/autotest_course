...
def treatment_sum(our_tuple):
    """
    Функция принимает кортеж из 2 элементов и возвращает их сумму. При невозможности сложения обрабатывает исключения
    :param our_tuple: tuple Кортеж из двух элементов
    :return: int Сумма двух элементов
    """
    try:
        if len(our_tuple) > 2:
