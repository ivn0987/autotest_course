...
class Trigon:
    """
    Класс абстрактного треугольника
    """
    def __init__(self, *args):
        """
        Метод принимает неизвестное количество атрибутов, являющихся сторонами треугольника.
        После проверки инициализирует стороны треугольника
        :param args: tuple Неизвестное количество аргументов, могущих являться сторонами треугольника
        """
        if len(args) != 3:
        ...
        b = args[1]
        c = args[2]
        if (a + b > c and a + c > b and b + c > a) is not True:
