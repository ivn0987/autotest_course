...
def which_triangle(a, b, c):
    """
    Функция определяет тип треугольника по трем сторонам. Или "не треугольник"
    :param a: int Длина стороны a
    :param b: int Длина стороны b
    :param c: int Длина стороны c
    :return: (type_triangle) str Тип треугольника (Равносторонний", "Равнобедренный", "Обычный) или "Не треугольник"
    """
