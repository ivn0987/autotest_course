...
def global_changes():
    """
    Функция изменяет глобальные переменные на заданные. Функция ничего не принимает и возвращает измененные значения глобальных переменных
    :return: (number, string) int, str Измененные глобальные переменные
    """
