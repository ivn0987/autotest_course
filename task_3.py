...
def everything_for_your_cat(cats_data):
    """
    Функция принимает список кортежей cats_data
    в формате Кличка котика, Возраст котика, Имя покупателя, Фамилия покупателя
    и возвращает строку с данными кортежей списка
    в формате Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n
    :param cats_data: list Список кортежей с данными о котах и владельцах
    :return: (our_str) str Строка с данными об уникальных владельцах и их котах
    """
    our_str = ''
    if len(cats_data):
        our_dict = {}
        for item in cats_data:
            ...
            cat = f'{item[0]}, {item[1]}'
            if fio in our_dict:
                our_dict[fio] = f'{our_dict[fio]}; {cat}'
            else:
                our_dict[fio] = f'{cat}'
        for data_item in our_dict:
            our_str = f'{our_str}{data_item}: {our_dict[data_item]}\n'
    return our_str
