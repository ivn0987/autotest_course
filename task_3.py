...
def segment(first_tuple, second_tuple):
    """
    Функция принимает да кортежа с наборами координат. Если координаты корректны, то возвращает сумму координат.
    Если нет - возвращает текст исключения задом наперед
    :param first_tuple: tuple Кортеж с координатами точки
    :param second_tuple: tuple Кортеж с координатами точки
    :return: int or str Сумма координат или перевернутая строка текста ошибки
    """
    try:
