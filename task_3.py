...
class PublicTransport:
    """
    Родительский класс общественного транспорта
    """
    def __init__(self, brand, engine_power, year, color, max_speed):
        """
        Метод принимает характеристики транспорта
        :param brand: str Марка
        :param engine_power: int Мощность двигателя
        :param year: int Год выпуска
        :param color: str Цвет
        :param max_speed: int Максимальная скорость
        """
        self.brand = brand
    ...
    def info(self):
        """
        Метод возвращает информация об экземпляре транспорта
        :return: Данные транспорта: марка, цвет, год выпуска, мощность двигателя
        """
        return print(self.brand, self.year, self.color, self._engine_power)
...
class Bus(PublicTransport):
    ...
    def __init__(self, brand, engine_power, year, color, max_speed, passengers, park, fare):
        """
        Метод принимает характеристики автобуса
        :param brand: str Марка
        :param engine_power: int Мощность двигателя
        :param year: int Год выпуска
        :param color: str Цвет
        :param max_speed: int Максимальная скорость
        :param passengers: int Кол-во пассажиров
        :param park: str Парк приписки
        :param fare: int Стоимость проезда
        """
    ...
    def park(self):
        """
        Метод возвращает информацию о парке приписки
        :return: int Номер парка
        """
        return self.__park
    ...
    def park(self, park):
        """
        Метод принимает номер парка, если он в диапазоне от 1000 до 9999
        :param park: int Номер парка
        """
...
class Tram(PublicTransport):
    ...
    def __init__(self, brand, engine_power, year, color, max_speed, route, path, fare):
        """
        Метод принимает характеристики трамвая
        :param brand: str Марка
        :param engine_power: int Мощность двигателя
        :param year: int Год выпуска
        :param color: str Цвет
        :param max_speed: int Максимальная скорость
        :param route: int Номер маршрута
        :param path: int Длина маршрута
        :param fare: int Стоимость проезда
        """
        super().__init__(brand, engine_power, year, color, max_speed)
        self.__route = route
    ...
    def how_long(self):
        """
        Метод возвращает время в пути по формуле max_speed/(4*path)
        :return: int Время прохождения маршрута
        """
